...
def translate_feature_keep_seqs(aln, feature):
    '''
...
def make_annotation_dict(feature_table, seqid):
    ...
    annotations = {}
    for fname, feat in feature_table.items():
        annotations[fname] = {'seqid': seqid,
                              'type': feat.type,
